...
@implementation DNMonitorRunloop

+ (instancetype)sharedInstance
{
    static dispatch_once_t once;
    static DNMonitorRunloop *sharedInstance;
    dispatch_once(&once, ^{
...
{
    DNMonitorRunloop *instance = [DNMonitorRunloop sharedInstance];
    // 记录状态值
...
//                        continue;
                    ...
                    NSString *backtrace = [DNCallStack DN_backtraceOfMainThread];
                    NSLog(@"++++%@",backtrace);
